...
//			console.log(post); //debugging purposes only
			var content = $(post.content);
			content = content[0].innerHTML;
			quoteDiv.innerHTML = '"' + content + '"';
			
//			 If the Source is available, use it. Otherwise no source will be added
			if (typeof post.custom_meta !== 'undefined' && typeof post.custom_meta.Source !== 'undefined') {
				document.getElementById("source").href = post.link;
			}
		},
		cache: false
	});
